...
# COMMAND ----------
# Medallion paths
landing_path = f"abfss://finanzas-landing@{storage_account}.dfs.core.windows.net/balance/"
staging_path = f"abfss://finanzas-staging@{storage_account}.dfs.core.windows.net/balance/"
curated_path = f"abfss://finanzas-curated@{storage_account}.dfs.core.windows.net/balance/"
logs_path    = f"abfss://finanzas-logs@{storage_account}.dfs.core.windows.net/balance/real/"
